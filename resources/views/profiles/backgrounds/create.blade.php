        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    Add Background Information for {{ $profile->full_name }}
                </div>

                <div class="card-body">
                    <form action="{{ route('profiles.backgrounds.store', $profile) }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="title" class="form-label">
                                        <span id="titleLabel">Title</span> <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="organization" class="form-label">
                                        <span id="orgLabel">Institution/Company</span> <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('year_from') is-invalid @enderror" 
                                           ...
                                           value="{{ old('year_from', date('Y') - 5) }}" required>
                                    @error('year_from')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
